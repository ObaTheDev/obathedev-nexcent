...
const Clients = () => {
    return(
        <div className="bg-white items-center justify-center text-center py-[3%]">
            ...
            <h1 className="text-themeGreen font-semibold mt-8 ml-[35%] w-[30%] text-center text-2xl">Manage your entire community in a single system</h1>
            <p className="mt-2 text-gray-900">Who is Nextcent suitable for?</p>

            <div className="grid grid-cols-3 px-[10%] gap-8 mt-[3%]">
            <motion.div
            initial={{x: -100, opacity: 0}} whileInView={{x:0, opacity: 1}} transition={{duration: 3}}  whileHover={{ y: [-5, 5, -5], transition: { duration: 2, repeat: Infinity } }}
                className="col-span-1 flex flex-col justify-center items-center bg-silver w-[95%] shadow-gray-500 shadow-lg p-[10px] rounded-xl">
                    <img src={icon1} alt="" />
                    <h1 className= "text-themeGreen font-semibold text-xl w-[50%]">Membership Organizations</h1>
            ...
            <motion.div
                ...
                className="col-span-1 flex flex-col justify-center items-center bg-silver w-[95%] shadow-gray-500 shadow-lg p-[10px] rounded-xl overflow-hidden">
                    <img src={icon3} alt="" />
                    <h1 className= "text-themeGreen font-semibold text-xl w-[50%]">Groups</h1>
                    <p className="text-gray-500 mt-5  w-[80%]">Our membership management software provides full automation of membership renewals and payments</p>
            </motion.div>
            </div>
            <div className="grid grid-cols-3 px-[5%] py-[6%] bg-black mt-[5%]">
                <div className="col-span-1">
                    <img className="h-[300px] w-[300px]" src={rafiki} alt="" />
                </div>

                <div className="grid text-left col-span-2">
                    <h1 className="text-themeGreen font-semibold w-[70%]  text-left text-3xl">The unseen of spending three years at Pixelgrade</h1>
                    <p className="text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet justo ipsum. Sed accumsan quam vitae est varius fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.</p>
                    <Link to="/features">  <button type="button" className="bg-themeGreen rounded-sm text-white py-3 px-2">Learn More</button></Link>
                </div>
            </div>
        </div>
    )
