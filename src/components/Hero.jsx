    ...
    return(
        ...
        <div className="lg:grid lg:grid-cols-3">
            ...
            <div className="grid-cols-2 col-span-2">
                <h1 className="lg:text-[4em] font-bold  tracking-wide text-silver mt-10">Lessons and insights <span className="text-themeGreen">from 8 years</span></h1>
                <p className="text-gray-400">Where to grow your business as a photographer: site or social media?</p>
                <button type="button" className="px-7 py-2 ml-[27%] lg:ml-0  rounded-[3px] bottom-2 bg-themeGreen text-white hover:text-themeGreen hover:bg-black mt-[15px] border-[1px] border-black hover:border-themeGreen">
            ...
            <div className="grid-cols-1 col-span-1 relative ml-6 hidden lg:visible lg:block">
